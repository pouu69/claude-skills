...
description: |
  ...
  Use when: designing database schemas, implementing migrations, optimizing queries, setting up data pipelines,
  managing database operations, or when user mentions database, SQL, schema, migration, or data modeling.
license: MIT
metadata:
  author: pouu69
  version: "1.0.0"
